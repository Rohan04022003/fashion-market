...
const Shoes = () => {
  ...
  const BreadcrumbNavigation: string[] = ['Shoes', selectedFilters.Categories, selectedFilters.Tags, selectedFilters.Ratings];

  const { filteredProducts, applyFilter, searchTerm, setSearchTerm, categoryFilteredProducts } = useProductFilters('shoes');
  ...
  const ShoesFilters: FiltersType = {
    Categories: [
      'Men Sneakers',
      'Men Loafers',
      'Men Formal Shoes',

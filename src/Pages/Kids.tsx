...
const Kids = () => {
  ...
  const BreadcrumbNavigation: string[] = ['Kids', selectedFilters.Categories, selectedFilters.Tags, selectedFilters.Ratings];

  const { filteredProducts, applyFilter, searchTerm, setSearchTerm, categoryFilteredProducts } = useProductFilters('boy');
